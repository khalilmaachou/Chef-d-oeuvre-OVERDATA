...
class OmniglotNShotDataset():
    ...
    def load_data_cache(self, data_pack):
        ...
        for sample in range(1000):
            ...
            target_x = np.zeros((self.batch_size, self.samples_per_class, 28, 28, 1), dtype=np.int32)
            target_y = np.zeros((self.batch_size, self.samples_per_class), dtype=np.int32)
