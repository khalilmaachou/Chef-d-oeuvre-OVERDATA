...
# data path
parser.add_argument("--traindir", type=str, default='../DCASE-DATASET/Development_Set/Training_Set') #root dir for the training dataset
parser.add_argument("--valdir", type=str, default='../DCASE-DATASET/Development_Set/Validation_Set') #root dir for the validation dataset
